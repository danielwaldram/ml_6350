...
def process_trees(iteration, full_attributes):
    ...
    new_tree = id3(rand_examples, rand_examples, full_attributes, remain_attributes, None, "entropy")
...
def main():
    ...
    args = ((model_num, full_attributes) for model_num in num_models_list)
    ...
    for j in range(num_models):
        average_error_test, votes = bag_get_predictions_error(votes_test_dict, testing_predictions[j], processed_test)
...
if __name__ == "__main__":
    ...
    print("Avg Var Single Tree: ", average_var)
    print("Avg Bias Single Tree: ", average_bias)
    print("Avg Gen Squared Error: ", average_var + average_bias)
    ...
    print("Avg Var Bagged Tree: ", average_var)
    print("Avg Bias Bagged Tree: ", average_bias)
    print("Avg Gen Squared Error: ", average_var + average_bias)
